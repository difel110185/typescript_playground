...
function () {
  function Attributes(data) {
    ...
    this.set = function (updatedProps) {
      // @ts-ignore
      Object.assign(_this.data, updatedProps);
    };
  }
...
function () {
  ...
  View.prototype.mapRegions = function (fragment) {
    var regionsMaps = this.regionsMap();

    for (var key in regionsMaps) {
      var selector = regionsMaps[key];
